...
/**
 * Clase crea un analizador lexico mediante librerias de jflex
 * 
...
public class Compilador {
     ...
     * @param args Parametros de ejecucion
     */
    /**
    public static void main(String[] args) {
        String path="src/compilador/Lexer.flex";
        generarLexer(path);    
    ...
    */
    /**
     * MEtodo que genera el archivo lexer mediante librerias
     * @param path 
     */
    /**
